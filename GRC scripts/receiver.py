...
# Title: Receiver
# Generated: Sun Jan 31 19:09:26 2016
##################################################
...
class receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 600, 100, firdes.WIN_HAMMING, 6.76))
        ...
        self.connect((self.olin_uhd09, 0), (self.low_pass_filter_0, 0))
...
# QT sink close method reimplementation
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 600, 100, firdes.WIN_HAMMING, 6.76))
